...
Blockly.Blocks['table'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldDropdown([["table","OPTIONNAME"], ["option","OPTIONNAME"], ["option","OPTIONNAME"]]), "NAME");
...
Blockly.Blocks['decimal'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldNumber(2.5, -Infinity, Infinity, 2), "NAME");
    this.setOutput(true, null);
    this.setColour(345);
 this.setTooltip("");
 this.setHelpUrl("");
...
Blockly.Blocks['opcion'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldDropdown([["table","OPTIONNAME"], ["option","OPTIONNAME"], ["option","OPTIONNAME"]]), "NAME")
        .appendField(new Blockly.FieldDropdown([["column","OPTIONNAME"], ["option","OPTIONNAME"], ["option","OPTIONNAME"]]), "COLUMNA");
    this.setOutput(true, null);
    this.setColour(345);
 this.setTooltip("");
 this.setHelpUrl("");
